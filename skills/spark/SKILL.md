...
**The terminal state is delivering the spec to the user. STOP.** Do NOT invoke any other skill, do NOT start implementation planning, and do NOT write code. Report the spec path and end your turn — the user will decide what to do with the spec.
